...
export APP_HIBERNATE_OPTS="-Dhibernate.dialect=$APP_HIBERNATE_DIALECT -Dhibernate.hbm2ddl.auto=$APP_HIBERNATE_HBM2DDL_AUTO -Dhibernate.default_schema=$APP_HIBERNATE_DEFAULT_SCHEMA"
